                    ...
                    <div className="mt-6 pt-6 border-t border-white/10 animate-fade-in">
                        ...
                        <div className="relative group">
                            <input
                                ...
                                readOnly
                                value={generatedKey}
                                className="w-full bg-black/40 border border-green-500/30 rounded-lg px-4 py-3 text-green-300 font-mono text-sm focus:outline-none"
                            />
                            <button
                                onClick={copyToClipboard}
                                className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-white/5 hover:bg-white/10 rounded-md transition-colors"

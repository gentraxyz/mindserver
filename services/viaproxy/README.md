...
First start the ViaProxy container, then open another terminal in the MindServer directory.\
Run `docker attach mindserver-viaproxy-1` in the new terminal to attach to the container.\
